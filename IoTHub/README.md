...
If your lab environment has been pre-provisioned for you, you can skip the next step of creating a resource group and instead use the labuserXX_iot_rg that has been assigned to you to create the IoT hub.
